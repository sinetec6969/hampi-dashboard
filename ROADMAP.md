...
> **Current status:** Beta-track. DMR voice decode and call history are functional. Audio playback is work-in-progress. The features below are planned additions before a stable beta release.
